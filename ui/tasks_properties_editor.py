...
class TaskPropertiesEditorBuild(QtWidgets.QWidget):
    ...
    def create_widgets(self):
        ...
        self.save_btn = QtWidgets.QPushButton("Update Task Briefing")
...
class TaskPropertiesEditorCore(TaskPropertiesEditorBuild):
    ...
    def create_connections(self):
        self.save_btn.clicked.connect(self.update_task_briefing_text)
        self.update_btn.clicked.connect(self.update_task_properties)
    ...
    def update_task_properties(self):
        ...
        get_assigned_to = self.assigned_to_cb.currentText()
    ...
    def load_user(self, task_doc: dict):
        user = task_doc[self.doc_attrib.assigned_to]
