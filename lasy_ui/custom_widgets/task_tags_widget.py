...
from lasy_ops.tdb_attributes_definitions import TagsAttributesDefinitions, TaskAttributesDefinitions
from lasy_ops.tdb_attributes_paths import TagsAttributesPaths, TasksAttributesPaths
